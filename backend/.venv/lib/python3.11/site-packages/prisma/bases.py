...
class BaseProgressEvent(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ProgressEvent']] = 'ProgressEvent'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ProgressEventActions[_PrismaModelT]':
        from .client import get_client

        return actions.ProgressEventActions[_PrismaModelT](client or get_client(), cls)


class BaseProcessedData(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ProcessedData']] = 'ProcessedData'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ProcessedDataActions[_PrismaModelT]':
        from .client import get_client

        return actions.ProcessedDataActions[_PrismaModelT](client or get_client(), cls)
