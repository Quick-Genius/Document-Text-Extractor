...
SCHEMA_PATH = Path('/Users/bhargavkalambhe/Downloads/Predusk Technology pvt ltd/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/bhargavkalambhe/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    progressevent: 'actions.ProgressEventActions[models.ProgressEvent]'
    processeddata: 'actions.ProcessedDataActions[models.ProcessedData]'
    ...
    def __init__(
        ...
        *,
        ...
        self.progressevent = actions.ProgressEventActions[models.ProgressEvent](self, models.ProgressEvent)
        self.processeddata = actions.ProcessedDataActions[models.ProcessedData](self, models.ProcessedData)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/bhargavkalambhe/Downloads/Predusk Technology pvt ltd/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    job: 'JobBatchActions'
    progressevent: 'ProgressEventBatchActions'
    processeddata: 'ProcessedDataBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.progressevent = ProgressEventBatchActions(self)
        self.processeddata = ProcessedDataBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ProgressEventBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.ProgressEventCreateInput,
        include: Optional[types.ProgressEventInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.ProgressEventCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.ProgressEventWhereUniqueInput,
        include: Optional[types.ProgressEventInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.ProgressEventUpdateInput,
        where: types.ProgressEventWhereUniqueInput,
        include: Optional[types.ProgressEventInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.ProgressEventWhereUniqueInput,
        data: types.ProgressEventUpsertInput,
        include: Optional[types.ProgressEventInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.ProgressEventUpdateManyMutationInput,
        where: types.ProgressEventWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.ProgressEvent,
    ...
    def delete_many(
        self,
        where: Optional[types.ProgressEventWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.ProgressEvent,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ProcessedDataBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.ProcessedDataCreateInput,
        include: Optional[types.ProcessedDataInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.ProcessedDataCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.ProcessedDataWhereUniqueInput,
        include: Optional[types.ProcessedDataInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.ProcessedDataUpdateInput,
        where: types.ProcessedDataWhereUniqueInput,
        include: Optional[types.ProcessedDataInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.ProcessedDataWhereUniqueInput,
        data: types.ProcessedDataUpsertInput,
        include: Optional[types.ProcessedDataInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.ProcessedDataUpdateManyMutationInput,
        where: types.ProcessedDataWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.ProcessedData,
    ...
    def delete_many(
        self,
        where: Optional[types.ProcessedDataWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.ProcessedData,
